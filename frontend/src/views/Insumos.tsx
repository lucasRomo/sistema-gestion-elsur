...
export const Insumos: React.FC = () => {
  ...
  const { insumos, guardar } = useInsumos();
  ...
  return (
    <div className="container-fluid px-0">
      ...
      {/* Botonera principal */}
      <div className="d-flex flex-wrap gap-3 justify-content-between align-items-center pt-3">
  <button onClick={() => navigate('/dashboard')} className="btn btn-danger px-4 py-2 font-monospace">
    Volver
  </button>
  <button className="btn btn-success px-4 py-2 font-monospace fw-bold" onClick={() => { setInsumoEditando(null); setShowModalForm(true); }}>
