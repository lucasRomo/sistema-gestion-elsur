  ...
  return (
    <>
      <div className="container-fluid px-0">
        ...
        <div className={`d-flex justify-content-between align-items-center mt-4 pt-3 border-top ${isDark ? 'border-secondary' : 'border-light-subtle'} font-monospace`}>
          <button onClick={() => navigate('/dashboard')} className="btn btn-danger px-5 py-2">Volver</button>
          <div className="d-flex gap-3">
            <button className="btn px-4 py-2 text-white fw-normal" style={{ backgroundColor: '#17a2b8', borderColor: '#0e5a66' }}>
              Modificar Varios Precios
            </button>
            <button className="btn px-4 py-2 text-white fw-normal" style={{ backgroundColor: '#ca9e1b', borderColor: '#94720c' }}>
              Cálculo de Gastos
            </button>
            <button 
          ...
          <div className="modal d-block" style={{ backgroundColor: 'rgba(0,0,0,0.7)', zIndex: 1060 }}>
            <div className="modal-dialog modal-sm modal-dialog-centered">
              ...
              >
                ...
                <p className="small" style={{ color: mutedText }}>Se sobreescribirán los datos del producto.</p>
