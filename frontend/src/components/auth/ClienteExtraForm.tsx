        ...
        <div className="modal-content p-4" style={{ backgroundColor: '#1e1e22' }}>
          <form onSubmit={onRegistrar}>
            ...
            <div className="mb-3">
              ...
              <input className="form-control" value={formData.personaDeContacto} onChange={e => handleChange('personaDeContacto', e.target.value)} required />
            </div>
            <div className="mb-3">
              <label className="text-light">Condición de Pago:</label>
              <input className="form-control" value={formData.condicionDePago} onChange={e => handleChange('condicionDePago', e.target.value)} required />
            </div>
            <div className="mb-3">
