            ...
            {!pasoJustificacion ? (
              <>
                <div className="row g-3 mb-4">
                  ...
                  <div className="col-md-6">
  <div className="p-3 rounded-3" style={{ backgroundColor: cardBg, border: `1px solid ${cardBorder}` }}>
    <span className="fw-bold text-info-custom fs-6 d-block mb-1">💳 Transferencias Digitales</span>
    <div className="d-flex justify-content-between small mt-3" style={{ color: textMuted }}>
      <span>Total Digital Acumulado:</span>
      <span className="fw-bold text-info-custom fs-5">${(datosArqueo?.totalTransferencias || 0).toLocaleString('es-AR')}</span>
    </div>
  </div>
</div>
</div>
...
>
  ...
  <input
    ...
    style={{
      ...
      borderColor: '#f59e0b', // Borde amarillo cálido
      borderRadius: '8px'
    }}
