...
export const RepositorioDigitalView: React.FC = () => {
  ...
  return (
    <div className={`container-fluid p-3 font-monospace ${textColor}`} style={{ backgroundColor: pageBg, minHeight: '100vh' }}>
              ...
              <>
                <div>
                  ...
                  <div className="small space-y-2">
                    <p className="mb-1"><strong className="text-secondary">Nombre:</strong> {documentoSeleccionado.titulo}</p>
                    <p className="mb-1"><strong className="text-secondary">Autor:</strong> {documentoSeleccionado.autor}</p>
                    <p className="mb-1">
                    ...
                    <p className="mb-1"><strong className="text-secondary">Tamaño de Archivo:</strong> {formatearTamano(documentoSeleccionado.tamanoBytes)}</p>
                    <p className="mb-1">
                      <strong className="text-secondary">Institución / Cátedra:</strong>{' '}
                      {documentoSeleccionado.area?.institucion?.nombreInstitucion} — {documentoSeleccionado.area?.nombreArea}
                    </p>
      ...
      {/* MODAL RÁPIDO: CREAR INSTITUCIÓN */}
      {modalNuevaInst && (
      ...
      {/* PREVISUALIZADOR PANTALLA COMPLETA */}
