        ...
        <div className="col-12 col-xl-8">
          <div className="p-4 rounded-4 h-100 shadow-sm d-flex flex-column justify-content-between im-surface">
            <div className="d-flex align-items-center justify-content-between mb-3 gap-2">
              ...
              <button type="button" onClick={() => abrirModalComparacion('ingresos')} className="btn btn-sm px-2 py-1 d-flex align-items-center gap-1" style={{ fontSize: '0.7rem', backgroundColor: 'transparent', border: '1px solid #8e45e0', color: '#8e45e0' }}>
        ...
        <div className="col-12 col-xl-4">
          <div className="p-4 rounded-4 h-100 shadow-sm d-flex flex-column justify-content-between im-surface">
            <div className="d-flex align-items-center justify-content-between mb-3 gap-2">
              ...
              <button type="button" onClick={() => abrirModalComparacion('mediosPago')} className="btn btn-sm px-2 py-1 d-flex align-items-center gap-1" style={{ fontSize: '0.7rem', backgroundColor: 'transparent', border: '1px solid #20c997', color: '#20c997' }}>
                <i className="bi bi-arrow-left-right"></i> Comparar
              </button>
            </div>
        ...
        <div className="col-12">
          <div className="p-4 rounded-4 shadow-sm im-surface">
            <div className="d-flex align-items-center justify-content-between mb-3 gap-2">
              ...
              <button type="button" onClick={() => abrirModalComparacion('egresos')} className="btn btn-sm px-2 py-1 d-flex align-items-center gap-1" style={{ fontSize: '0.7rem', backgroundColor: 'transparent', border: '1px solid #e22e2e', color: '#e22e2e' }}>
                <i className="bi bi-arrow-left-right"></i> Comparar
              </button>
            </div>
        ...
        <div className="col-12 col-xl-6">
          <div className="p-4 rounded-4 shadow-sm im-surface h-100 d-flex flex-column justify-content-between">
            <div className="d-flex align-items-center justify-content-between mb-3 gap-2">
              ...
              <button type="button" onClick={() => abrirModalComparacion('categoriasIngresos')} className="btn btn-sm px-2 py-1 d-flex align-items-center gap-1" style={{ fontSize: '0.7rem', backgroundColor: 'transparent', border: '1px solid #0dcaf0', color: '#0dcaf0' }}>
                <i className="bi bi-arrow-left-right"></i> Comparar
              </button>
            </div>
        ...
        <div className="col-12 col-xl-6">
          <div className="p-4 rounded-4 shadow-sm im-surface h-100 d-flex flex-column justify-content-between">
            <div className="d-flex align-items-center justify-content-between mb-3 gap-2">
              ...
              <button type="button" onClick={() => abrirModalComparacion('categoriasEgresos')} className="btn btn-sm px-2 py-1 d-flex align-items-center gap-1" style={{ fontSize: '0.7rem', backgroundColor: 'transparent', border: '1px solid #ffc107', color: '#ffc107' }}>
                <i className="bi bi-arrow-left-right"></i> Comparar
              </button>
            </div>
